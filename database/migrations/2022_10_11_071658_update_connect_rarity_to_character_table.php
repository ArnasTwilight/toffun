...
class UpdateConnectRarityToCharacterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('character', function (Blueprint $table) {
            ...
            $table->foreign('rarity_id', 'character_rarity_fk')->on('rarity')->references('id')->restrictOnUpdate()->nullOnDelete();
        });
    }
