...
class DelConnectAndColOnStarsToCharacterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('character', function (Blueprint $table) {
            ...
            $table->foreign('stars_id', 'character_stars_fk')->on('stars')->references('id')->cascadeOnUpdate()->cascadeOnDelete();
        });
    }
}
